...
The local-dev counterpart to :class:`industryiq.core.bedrock.BedrockEmbedder`.
...
Satisfies the :class:`~industryiq.core.embeddings.Embedder` protocol, so it pairs
