...
The cloud-API counterpart to :class:`industryiq.core.bedrock.BedrockLLM`: the same
...
Satisfies the same :class:`~industryiq.core.generation.GenerativeLLM` protocol as
the fakes and the Bedrock provider, so it is a drop-in alternative chosen in
:mod:`industryiq.api.deps`.
"""
