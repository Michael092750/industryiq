...
* :mod:`ragproject.api.rag_routes`   -- ingestion and one-shot query.
* :mod:`ragproject.api.chat_routes`  -- multi-round chat.
...
from ragproject.api.rag_routes import router as rag_router
