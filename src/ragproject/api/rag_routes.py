"""HTTP routes for ingestion and one-shot querying.

A thin layer over :class:`RagPipeline`: validate input, call the pipeline,
serialize the result. No RAG logic lives here -- that is all in
``ragproject.core``.
"""
